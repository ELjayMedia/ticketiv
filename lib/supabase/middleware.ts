 ...
 *   /api/discover/*, /api/search/suggest, /api/mobile/tickets/*,
 *   selected /api/scanner/* device endpoints,
 *   /api/payouts, /api/payments/paystack/webhook, /api/payments/momo/callback
 *
 * Onboarding gate:
