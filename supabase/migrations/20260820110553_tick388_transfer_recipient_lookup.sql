...
revoke all on function public.fn_lookup_transfer_recipient(text) from public,anon;
grant execute on function public.fn_lookup_transfer_recipient(text) to authenticated,service_role;;
