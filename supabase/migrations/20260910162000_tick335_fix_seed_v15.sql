-- TICK-335 v15: fix ledger entry types to match constraint
...
begin
  ...
  -- Insert ledger entries (correct types per constraint: order_gross, fee, payment_net)
  insert into public.ledger_entries (id, org_id, order_id, payment_id, type, amount_cents, currency) values
    ...
    ('da7a0008-0000-4000-8000-000000000002', ORG_A, O_PAID, P_PAID, 'fee', -975, 'ZAR'),
