-- TICK-335 v11: fix fn_teardown_uat_fixtures to delete events before venues (FK constraint)
...
begin
  ...
  -- Delete events BEFORE venues (FK constraint: events_venue_id_fkey)
  delete from public.events where id in (
    'da7a0003-0000-4000-8000-000000000001',
    'da7a0003-0000-4000-8000-000000000002',
    'da7a0003-0000-4000-8000-000000000003'
  );
