-- Returns aggregate completed-resale counts for a list of seller IDs.
-- Used to surface seller trust signals on public resale listings without
-- exposing any personal data — only a per-seller count is returned.
