-- TICK-335 v13: fix fn_seed_uat_fixtures to provide ticket_code (NOT NULL column)
...
begin
  ...
  insert into public.ledger_entries (id, order_id, entry_type, amount_cents, currency) values
    ('da7a0008-0000-4000-8000-000000000001', O_PAID, 'order_gross', 15000, 'ZAR'),
    ('da7a0008-0000-4000-8000-000000000002', O_PAID, 'platform_fee', -975, 'ZAR'),
    ('da7a0008-0000-4000-8000-000000000003', O_PAID, 'payment_net', 14025, 'ZAR');
