...
-- Generated from production database: radsfmlsjznqvcpogluo
-- Date: 2026-09-05
-- This migration represents the current state of production schema
...
BEGIN
  ...
  FROM public.payment_provider_settings WHERE is_enabled = true;

  SELECT coalesce(payment_providers, '{}'::text[]) INTO v_org_providers
  ...
  IF p_event_id IS NOT NULL THEN
    SELECT coalesce(payment_providers, '{}'::text[]) INTO v_event_providers
    FROM public.events WHERE id = p_event_id;
    IF array_length(v_event_providers, 1) > 0 THEN
      SELECT array_agg(e ORDER BY e) INTO v_platform_providers
      FROM unnest(v_event_providers) e WHERE e = ANY(v_platform_providers);
    END IF;
  END IF;

  IF p_ticket_type_id IS NOT NULL THEN
    SELECT coalesce(payment_providers, '{}'::text[]) INTO v_ticket_providers
    FROM public.ticket_types WHERE id = p_ticket_type_id;
    IF array_length(v_ticket_providers, 1) > 0 THEN
      SELECT array_agg(e ORDER BY e) INTO v_platform_providers
      FROM unnest(v_ticket_providers) e WHERE e = ANY(v_platform_providers);
    END IF;
  END IF;
...
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."events" TO "anon";
...
GRANT SELECT,MAINTAIN ON TABLE "public"."membership_invites" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."membership_invites" TO "authenticated";
...
GRANT SELECT,MAINTAIN ON TABLE "public"."device_sessions" TO "authenticated";
...
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."event_live_stats" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."event_live_stats" TO "authenticated";
...
GRANT SELECT,MAINTAIN ON TABLE "public"."devices" TO "authenticated";
...
GRANT SELECT,MAINTAIN ON TABLE "public"."payouts" TO "authenticated";
...
GRANT SELECT,INSERT,MAINTAIN ON TABLE "public"."refunds" TO "authenticated";
...
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."admin_action_catalog" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."admin_action_catalog" TO "authenticated";
...
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."payment_attempts" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."payment_attempts" TO "authenticated";
GRANT ALL ON TABLE "public"."payment_attempts" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."admin_attention_queue" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."admin_attention_queue" TO "authenticated";
GRANT ALL ON TABLE "public"."admin_attention_queue" TO "service_role";



GRANT SELECT,MAINTAIN ON TABLE "public"."order_items" TO "anon";
GRANT SELECT,MAINTAIN ON TABLE "public"."order_items" TO "authenticated";
...
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."organizations" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."organizations" TO "authenticated";
...
GRANT SELECT,MAINTAIN ON TABLE "public"."scans" TO "authenticated";
GRANT ALL ON TABLE "public"."scans" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."ticket_types" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."ticket_types" TO "authenticated";
GRANT ALL ON TABLE "public"."ticket_types" TO "service_role";



GRANT SELECT,MAINTAIN ON TABLE "public"."webhooks" TO "authenticated";
GRANT ALL ON TABLE "public"."webhooks" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."admin_command_centre_metrics" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."admin_command_centre_metrics" TO "authenticated";
GRANT ALL ON TABLE "public"."admin_command_centre_metrics" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."admin_event_readiness" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."admin_event_readiness" TO "authenticated";
GRANT ALL ON TABLE "public"."admin_event_readiness" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."app_audit_log" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."app_audit_log" TO "authenticated";
GRANT ALL ON TABLE "public"."app_audit_log" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."audit_log" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."audit_log" TO "authenticated";
GRANT ALL ON TABLE "public"."audit_log" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."admin_recent_operations" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."admin_recent_operations" TO "authenticated";
...
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."admin_workspace_actions" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."admin_workspace_actions" TO "authenticated";
GRANT ALL ON TABLE "public"."admin_workspace_actions" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."feature_flags" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."feature_flags" TO "authenticated";
GRANT ALL ON TABLE "public"."feature_flags" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."org_members" TO "authenticated";
GRANT ALL ON TABLE "public"."org_members" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."price_rules" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."price_rules" TO "authenticated";
GRANT ALL ON TABLE "public"."price_rules" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."pricing_plans" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."pricing_plans" TO "authenticated";
GRANT ALL ON TABLE "public"."pricing_plans" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."seat_holds" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."seat_holds" TO "authenticated";
GRANT ALL ON TABLE "public"."seat_holds" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."admin_workspace_operating_counts" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."admin_workspace_operating_counts" TO "authenticated";
GRANT ALL ON TABLE "public"."admin_workspace_operating_counts" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."artists" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."artists" TO "authenticated";
...
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."credential_batches" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."credential_batches" TO "authenticated";
GRANT ALL ON TABLE "public"."credential_batches" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."credential_entitlements" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."credential_entitlements" TO "authenticated";
GRANT ALL ON TABLE "public"."credential_entitlements" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."credential_inventory" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."credential_inventory" TO "authenticated";
GRANT ALL ON TABLE "public"."credential_inventory" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."credential_taps" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."credential_taps" TO "authenticated";
GRANT ALL ON TABLE "public"."credential_taps" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."device_setup_codes" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."device_setup_codes" TO "authenticated";
GRANT ALL ON TABLE "public"."device_setup_codes" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."event_artists" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."event_artists" TO "authenticated";
GRANT ALL ON TABLE "public"."event_artists" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."event_catalog" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."event_catalog" TO "authenticated";
GRANT ALL ON TABLE "public"."event_catalog" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."event_categories" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."event_categories" TO "authenticated";
GRANT ALL ON TABLE "public"."event_categories" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."event_dates" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."event_dates" TO "authenticated";
GRANT ALL ON TABLE "public"."event_dates" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."event_favourites" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."event_favourites" TO "authenticated";
...
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."event_metrics_daily" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."event_metrics_daily" TO "authenticated";
GRANT ALL ON TABLE "public"."event_metrics_daily" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."event_series" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."event_series" TO "authenticated";
GRANT ALL ON TABLE "public"."event_series" TO "service_role";



GRANT SELECT,MAINTAIN ON TABLE "public"."event_staff" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."event_staff" TO "authenticated";
GRANT ALL ON TABLE "public"."event_staff" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."event_summary" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."event_summary" TO "authenticated";
GRANT ALL ON TABLE "public"."event_summary" TO "service_role";



GRANT SELECT,MAINTAIN ON TABLE "public"."guestlist_entries" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."guestlist_entries" TO "authenticated";
GRANT ALL ON TABLE "public"."guestlist_entries" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."guestlist_fulfillments" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."guestlist_fulfillments" TO "authenticated";
GRANT ALL ON TABLE "public"."guestlist_fulfillments" TO "service_role";



GRANT SELECT,MAINTAIN ON TABLE "public"."ledger_entries" TO "authenticated";
GRANT ALL ON TABLE "public"."ledger_entries" TO "service_role";



GRANT ALL ON TABLE "public"."mv_event_sales" TO "service_role";
GRANT INSERT,DELETE,UPDATE ON TABLE "public"."mv_event_sales" TO "authenticated";



GRANT ALL ON TABLE "public"."mv_revenue_breakdown" TO "service_role";
GRANT INSERT,DELETE,UPDATE ON TABLE "public"."mv_revenue_breakdown" TO "authenticated";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."notification_mutes" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."notification_mutes" TO "authenticated";
...
GRANT SELECT ON TABLE "public"."order_adjustments" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."order_adjustments" TO "authenticated";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."order_financials" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."order_financials" TO "authenticated";
GRANT ALL ON TABLE "public"."order_financials" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."order_ledger_summary" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."order_ledger_summary" TO "authenticated";
GRANT ALL ON TABLE "public"."order_ledger_summary" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."org_metrics_daily" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."org_metrics_daily" TO "authenticated";
GRANT ALL ON TABLE "public"."org_metrics_daily" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."payment_methods" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."payment_methods" TO "authenticated";
...
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."payment_routing_rules" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."payment_routing_rules" TO "authenticated";
GRANT ALL ON TABLE "public"."payment_routing_rules" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."payout_accounts" TO "authenticated";
GRANT ALL ON TABLE "public"."payout_accounts" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."physical_credentials" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."physical_credentials" TO "authenticated";
GRANT ALL ON TABLE "public"."physical_credentials" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."price_rule_redemptions" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."price_rule_redemptions" TO "authenticated";
GRANT ALL ON TABLE "public"."price_rule_redemptions" TO "service_role";



GRANT MAINTAIN ON TABLE "public"."profiles" TO "anon";
GRANT INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."profiles" TO "authenticated";
...
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."push_subscriptions" TO "anon";
...
GRANT SELECT,MAINTAIN ON TABLE "public"."refund_items" TO "authenticated";
GRANT ALL ON TABLE "public"."refund_items" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."resale_listings" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."resale_listings" TO "authenticated";
...
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."seat_maps" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."seat_maps" TO "authenticated";
GRANT ALL ON TABLE "public"."seat_maps" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."seat_reservations" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."seat_reservations" TO "authenticated";
GRANT ALL ON TABLE "public"."seat_reservations" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."seats" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."seats" TO "authenticated";
GRANT ALL ON TABLE "public"."seats" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."series_follows" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."series_follows" TO "authenticated";
GRANT ALL ON TABLE "public"."series_follows" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."tapband_alerts" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."tapband_alerts" TO "authenticated";
GRANT ALL ON TABLE "public"."tapband_alerts" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."tapband_feature_configs" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."tapband_feature_configs" TO "authenticated";
GRANT ALL ON TABLE "public"."tapband_feature_configs" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."tapband_kill_switches" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."tapband_kill_switches" TO "authenticated";
GRANT ALL ON TABLE "public"."tapband_kill_switches" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."tapband_telemetry_events" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."tapband_telemetry_events" TO "authenticated";
GRANT ALL ON TABLE "public"."tapband_telemetry_events" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."ticket_type_channels" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."ticket_type_channels" TO "authenticated";
GRANT ALL ON TABLE "public"."ticket_type_channels" TO "service_role";



GRANT SELECT,MAINTAIN ON TABLE "public"."transfers" TO "anon";
GRANT SELECT,MAINTAIN ON TABLE "public"."transfers" TO "authenticated";
...
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."user_connections" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."user_connections" TO "authenticated";
GRANT ALL ON TABLE "public"."user_connections" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."user_friends" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."user_friends" TO "authenticated";
GRANT ALL ON TABLE "public"."user_friends" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."user_handles" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."user_handles" TO "authenticated";
GRANT ALL ON TABLE "public"."user_handles" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."user_notification_preferences" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."user_notification_preferences" TO "authenticated";
GRANT ALL ON TABLE "public"."user_notification_preferences" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."user_privacy_settings" TO "authenticated";
...
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."venues" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."venues" TO "authenticated";
GRANT ALL ON TABLE "public"."venues" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."v_events_public" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."v_events_public" TO "authenticated";
GRANT ALL ON TABLE "public"."v_events_public" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."v_artist_events_public" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."v_artist_events_public" TO "authenticated";
GRANT ALL ON TABLE "public"."v_artist_events_public" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."v_artist_public" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."v_artist_public" TO "authenticated";
GRANT ALL ON TABLE "public"."v_artist_public" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."v_event_kpis" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."v_event_kpis" TO "authenticated";
GRANT ALL ON TABLE "public"."v_event_kpis" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."v_event_lineup_public" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."v_event_lineup_public" TO "authenticated";
GRANT ALL ON TABLE "public"."v_event_lineup_public" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."v_event_public" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."v_event_public" TO "authenticated";
GRANT ALL ON TABLE "public"."v_event_public" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."v_event_sales_public" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."v_event_sales_public" TO "authenticated";
...
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."v_finance_reconciliation_queue" TO "authenticated";
GRANT ALL ON TABLE "public"."v_finance_reconciliation_queue" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."v_inbound_transfers" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."v_inbound_transfers" TO "authenticated";
GRANT ALL ON TABLE "public"."v_inbound_transfers" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."v_my_order_ledger_summary" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."v_my_order_ledger_summary" TO "authenticated";
...
GRANT SELECT ON TABLE "public"."v_my_tickets" TO "anon";
GRANT SELECT ON TABLE "public"."v_my_tickets" TO "authenticated";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."v_organizer_events_public" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."v_organizer_events_public" TO "authenticated";
GRANT ALL ON TABLE "public"."v_organizer_events_public" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."v_organizer_public" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."v_organizer_public" TO "authenticated";
GRANT ALL ON TABLE "public"."v_organizer_public" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."v_public_event_cards" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."v_public_event_cards" TO "authenticated";
GRANT ALL ON TABLE "public"."v_public_event_cards" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."v_user_events" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."v_user_events" TO "authenticated";
GRANT ALL ON TABLE "public"."v_user_events" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."v_user_orgs" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."v_user_orgs" TO "authenticated";
GRANT ALL ON TABLE "public"."v_user_orgs" TO "service_role";



GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."waitlists" TO "anon";
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."waitlists" TO "authenticated";
...
GRANT SELECT,INSERT,DELETE,MAINTAIN,UPDATE ON TABLE "public"."webhook_endpoints" TO "authenticated";
