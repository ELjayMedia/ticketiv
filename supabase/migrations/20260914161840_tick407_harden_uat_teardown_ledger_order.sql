-- TICK-407 follow-up: remove UAT ledger rows before deleting orders/payments.
-- Payment/order cascades update ledger foreign keys; leaving ledger rows in place
-- can violate ledger consistency while sibling payment rows are disappearing.
