...
--
-- Pure, side-effect-free. The recompute triggers and the three checkout RPCs will
-- delegate to this in the follow-up wiring step (2/2). Encodes the resolved fee
-- model (see the TICK-336 decision):
...
-- Organizer-facing net column requested in the decision (additive, populated by the wiring step).
