...
-- 3. Ops / admin-only RPCs (callers use service_role admin client).
...
-- 4. Bootstrap function: require caller owns the profile; revoke from anon.
...
-- 6. Public discovery views switch to security_invoker.
...
-- 7. Narrow anon SELECT policies for join targets.
