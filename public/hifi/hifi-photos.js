// Curated Unsplash event photography. Source URLs with sizing params.
// Each entry includes a fallback gradient for offline / failed loads.

const PHOTO_BASE = "https://images.unsplash.com/";
function photo(id, w = 800, q = 70) {
  return `${PHOTO_BASE}${id}?w=${w}&auto=format&fit=crop&q=${q}`;
}
