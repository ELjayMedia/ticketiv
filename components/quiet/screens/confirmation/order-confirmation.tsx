      ...
      <div className="mx-auto flex w-full max-w-[480px] flex-1 flex-col">
        ...
        <div className="flex-1 overflow-y-auto no-scrollbar">
          ...
          <section className="px-5 pb-6 text-center">
            <div className="mx-auto mb-4 inline-flex h-[72px] w-[72px] items-center justify-center rounded-full bg-accent-soft text-accent">
          ...
          <section className="pb-8">
            <div className="flex items-center justify-center gap-1.5 font-mono text-[11px] text-ink-3">
              ...
              Receipt sent to {order.receiptEmail}
            </div>
          </section>
