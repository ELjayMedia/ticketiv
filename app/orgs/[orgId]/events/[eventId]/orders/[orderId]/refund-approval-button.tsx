...
export function RefundApprovalButton({
  ...
  async function approve() {
    if (!confirm(`Approve ${amountLabel} and submit this refund to Paystack?`)) return
    setBusy(true)
    setError("")
    try {
      ...
      setError(cause instanceof Error ? cause.message : "Unable to submit refund")
    } finally {
      setBusy(false)
    }
  }
  ...
  return (
    <div className="flex flex-col items-end gap-1">
      ...
      >
        {busy ? "Submitting…" : "Approve refund"}
      </button>
