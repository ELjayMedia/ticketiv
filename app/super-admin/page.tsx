...
const WORKSPACES = [
  ...
  },
  {
    ...
    description: "Manage feature flags, promo codes, vouchers, fees and discounts.",
    href: "/super-admin/price-rules",
    icon: Flag,
  },
]
      ...
      <section className="mt-4 grid gap-4 xl:grid-cols-[1.15fr_0.85fr]">
        <Card className="rounded-2xl">
          <CardHeader className="border-b pb-3">
            <CardTitle className="flex items-center gap-2 text-base"><ClipboardList className="h-4 w-4" /> Operational workspaces</CardTitle>
          </CardHeader>
        ...
        <div className="grid gap-4">
          <Card className="rounded-2xl">
            <CardHeader className="border-b pb-3">
              <CardTitle className="flex items-center gap-2 text-base"><AlertTriangle className="h-4 w-4" /> Attention queue</CardTitle>
            </CardHeader>
          ...
          <Card className="rounded-2xl">
            <CardHeader className="border-b pb-3">
              <CardTitle className="flex items-center gap-2 text-base"><RadioTower className="h-4 w-4" /> Recent audit activity</CardTitle>
            </CardHeader>
            <CardContent className="space-y-3 p-3">
