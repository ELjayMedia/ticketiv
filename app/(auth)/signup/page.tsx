...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // For demo: set session and redirect
      const userId = `user-${accountType}-${Date.now()}`
      const role = accountType === "organizer" ? "organizer" : "attendee"
      ...
      setTimeout(() => {
        if (accountType === "organizer") {
          // Organizers go through onboarding
